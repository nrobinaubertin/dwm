...
static void mappingnotify(XEvent *e); // keyboard shortcuts
static void maprequest(XEvent *e); // keyboard shortcuts (apps)
...
setup(void)
{
	...
	wa.event_mask = SubstructureRedirectMask|SubstructureNotifyMask|PointerMotionMask
